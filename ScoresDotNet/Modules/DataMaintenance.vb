...
Module DataMaintenance
    ...
    Private Function CollectParameters(ByVal StartAt As Integer) As SqlParameter
        ...
        With myParameters
            ...
            Select Case CStr(myParamArray(StartAt, 4))
                ...
                Case "Money"
                    .Value = Convert.ToDouble(myParamArray(StartAt, 5))
            End Select
        End With
        Return myParameters
    End Function
    ...
    Public Sub Receive_TextString_ForNewFieldLength(ByVal myString As String)
        ...
        For i = 0 To (myArray.GetUpperBound(0)) - 1
            ...
            swek.Value = GetWeekInMonth(dyer.Value.ToString) : StartPosition += 1
    ...
    End Function
    Function GetWeekInMonth(stDate As String) As Integer
        Dim dtDate As Date
        dtDate = Convert.ToDateTime(Mid(stDate, 1, 4) + "/" + Mid(stDate, 5, 2) + "/" + Mid(stDate, 7, 2))
