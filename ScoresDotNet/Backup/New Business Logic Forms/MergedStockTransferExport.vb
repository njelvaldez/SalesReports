...
Public Class MergedStockTransferExport
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Name = "MergedStockTransferExport"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Merged Stock Transfer Export"
...
#End Region
    ...
    Private Sub MergedStockTransferExport_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub ExportToExcel()
        ...
        'Dim outFileName As String = Application.StartupPath & "\" & CType(ConfigurationSettings.AppSettings.Item("MergedStockTransferExport"), System.String) & " - " & MonthCalendar1.SelectionStart.ToString("MMMM") & _
        'MonthCalendar1.SelectionStart.ToString("yyyy") & "(Week" & NumericUpDown1.Value.ToString() & ")"
        Dim outFileName As String = Application.StartupPath & "\" & CType(ConfigurationSettings.AppSettings.Item("MergedStockTransferExport"), System.String) & "-00000001"
        ...
        Try
            ...
            SetupParameters(0, "@BatchNo", SqlDbType.VarChar, 8, "String", "00000001")
            SetupParameters(1, "@WeekNo", SqlDbType.Int, 4, "Integer", "1")

            Dim myDataTable As System.Data.DataTable = DataMaintenance.GetDataTable(ServerPath2, "MergedStockTransferExport", _
        ...
        MessageBox.Show("The file was successfully saved.", "Merged Stock Transfer Export")
        Excel.Visible = False
        Excel.DisplayAlerts = False
        wSheet = Nothing
        wBook = Nothing
