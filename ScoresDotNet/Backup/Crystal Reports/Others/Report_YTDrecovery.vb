...
Public Class Report_YTDrecovery
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ScoresDotNet.Report_YTDrecovery.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReport_YTDrecovery
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Report_YTDrecovery = New Report_YTDrecovery
        rpt.Site = Me.Site
        Return rpt
    End Function
