    ...
    Private Sub ShowMainScreen()
        ...
        Try
            If Trim(txtPassword.Text) <> "" Then
                s = "select password from NewScores..usertab where password = '" & Trim(txtPassword.Text) & "' "
                ...
                Else
                    ...
                    s = "select username from NewScores..UserTab where userid = '" & Trim(txtUserName.Text) & "' "
