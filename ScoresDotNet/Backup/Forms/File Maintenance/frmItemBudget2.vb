...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents dgDivC As System.Windows.Forms.DataGridTextBoxColumn
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.dgDivC = New System.Windows.Forms.DataGridTextBoxColumn
        ...
        Me.DataGridTableStyle1.GridColumnStyles.AddRange(New System.Windows.Forms.DataGridColumnStyle() {Me.dgDivC, Me.dgDiv, Me.dgStart, Me.dgEnd, Me.dgQty, Me.dgAmt, Me.dgrow, Me.dgCreate, Me.dgUpdate})
        ...
        '
        Me.dgDivC.Format = ""
        Me.dgDivC.FormatInfo = Nothing
        Me.dgDivC.MappingName = "divcode"
        Me.dgDivC.NullText = ""
        Me.dgDivC.Width = 0
        '
        'dgDiv
        ...
        'txtDivCode
        '
        Me.txtDivCode.Location = New System.Drawing.Point(839, 340)
        Me.txtDivCode.Name = "txtDivCode"
        Me.txtDivCode.Size = New System.Drawing.Size(48, 20)
        Me.txtDivCode.TabIndex = 156
...
#End Region
    ...
    Private Sub dgLineItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles dgLineItem.Click, dgLineItem.CurrentCellChanged
        ...
        With dgItemBudget
            txtDivCode.Text = .Item(.CurrentCell.RowNumber, 0).ToString
            txtDivname.Text = .Item(.CurrentCell.RowNumber, 1).ToString
            ...
            txtCreateDate.Text = .Item(.CurrentCell.RowNumber, 7).ToString
            txtCreateDate.Text = Format(CDate(txtCreateDate.Text), "MM/dd/yyyy")
            txtUpdateDate.Text = .Item(.CurrentCell.RowNumber, 8).ToString
            ...
            txtAmount.Text = .Item(.CurrentCell.RowNumber, 5).ToString
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        If Not MyDialogBox.DialogResult = DialogResult.Cancel Then
            ...
            z = "select top 1 c.divname "
            z = z & "from newscores..budgetdirect a "
            z = z & "  inner join newscores..itemdivision b on a.itemcode=b.itemcode "
            z = z & "  inner join newscores..division c on b.divcode=c.divcode "
            z = z & "where a.itemcode = '" & Trim(txtItemCode.Text) & "' "
            txtDivname.Text = FindValue(z)
            z = "select top 1 c.divcode "
            z = z & "from newscores..budgetdirect a "
            z = z & "  inner join newscores..itemdivision b on a.itemcode=b.itemcode "
            z = z & "  inner join newscores..division c on b.divcode=c.divcode "
            z = z & "where a.itemcode = '" & Trim(txtItemCode.Text) & "' "
            txtDivCode.Text = FindValue(z)
        End If
    End Sub
...
errpt:
    ...
    Private Sub txtAmount_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtAmount.KeyUp
        'Dim aChr As String
        'If Len(Trim(txtAmount.Text)) = 1 Then
        '    aChr = Trim(txtAmount.Text)
        'ElseIf Len(Trim(txtAmount.Text)) > 1 Then
        '    aChr = Mid(Trim(txtAmount.Text), Len(Trim(txtAmount.Text)) - 1, 1)
        'ElseIf Len(Trim(txtAmount.Text)) = 0 Then
        '    Exit Sub
        'End If
        ''If e.KeyValue = 13 Then      ' tests if the key pressed is the "enter key"
        ''    SendKeys.Send("{TAB}")   ' sends the focus to the next control/tabstop
        ''End If
        'If NumKeys(aChr, e.KeyData, "NORM") = False Then
    ...
    Private Sub txtQty_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtQty.KeyUp
        'Dim aChr As String
        'If Len(Trim(txtQty.Text)) = 1 Then
        '    aChr = Trim(txtQty.Text)
        'ElseIf Len(Trim(txtQty.Text)) > 1 Then
        '    aChr = Mid(Trim(txtQty.Text), Len(Trim(txtQty.Text)) - 1, 1)
