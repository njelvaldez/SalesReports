...
#End Region
    ...
    Private Sub Sub_Insert()
        Try
            ...
            LogHelper.InsertLog("CallRateBudgetCT_Insert.Success")
        Catch ex As Exception
            MsgBox(ex.Message)
            LogHelper.InsertLog("CallRateBudgetCT_Insert.Error: " & ex.Message)
        End Try
    End Sub
    Private Sub Sub_Update()
        Try
            ...
            LogHelper.InsertLog("CallRateBudgetCT_Update.Success")
        Catch ex As Exception
            MsgBox(ex.Message)
            LogHelper.InsertLog("CallRateBudgetCT_Update.Error: " & ex.Message)
        End Try
    End Sub
    Private Sub Sub_Show()
        Try
            ...
            LogHelper.InsertLog("CallRateBudgetCT_Show.Success")
        Catch ex As Exception
            MsgBox(ex.Message)
            LogHelper.InsertLog("CallRateBudgetCT_Show.Error: " & ex.Message)
        End Try
    End Sub
    ...
    Private Sub Sub_Delete()
        Try
            ...
            LogHelper.InsertLog("CallRateBudgetCT_Delete.Success")
        Catch ex As Exception
            MsgBox(ex.Message)
            LogHelper.InsertLog("CallRateBudgetCT_Delete.Error: " & ex.Message)
        End Try
    End Sub
