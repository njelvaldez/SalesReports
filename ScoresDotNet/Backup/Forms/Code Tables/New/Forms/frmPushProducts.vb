...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.DataGridTableStyle1.MappingName = "PushProducts_Show"
        '
        ...
        Me.Name = "frmPushProducts"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.Manual
        Me.Text = "Push Products"
...
#End Region
    ...
    Private Sub SaveChanges()
        Select Case EditMode
            Case True
                ...
                If DataMaintenance.ExecuteCommand(ServerPath2, "PushProducts_Update", CommandType.StoredProcedure, 5) Then
            ...
            Case False
                ...
                If DataMaintenance.ExecuteCommand(ServerPath2, "PushProducts_Insert", CommandType.StoredProcedure, 4) Then
    ...
    Private Sub Sub_Select(ByVal dbParams() As String, ByVal UpdMode As String)
        ...
        End Select
        For i = 0 To (RemoteDataSet2.PushProducts_Show.Rows.Count - 1)
            With DataGrid1
    ...
    Private Sub Load_DataGrid()
        If RemoteDataSet2.PushProducts_Show.Count > 0 Then RemoteDataSet2.PushProducts_Show.Clear()
        Dim BusinessObject As New BusinessLayer.clsFileMaintenance
        BusinessObject.Sub_Show(ServerPath2, "PushProducts_Show", CommandType.StoredProcedure, RemoteDataSet2, "PushProducts_Show")
        DataGrid1.DataSource = RemoteDataSet2.PushProducts_Show
    End Sub
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        If MessageBox.Show("Delete this product line?", "Product Lines", MessageBoxButtons.YesNo) = DialogResult.Yes Then
            ...
            If DataMaintenance.ExecuteCommand(ServerPath2, "PushProducts_Delete", CommandType.StoredProcedure, 1) = True Then
