...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmUserMaint))
        ...
        Me.DataGrid1.Size = New System.Drawing.Size(1256, 376)
        ...
        Me.txtUserId.Location = New System.Drawing.Point(111, 417)
        ...
        Me.Label1.Location = New System.Drawing.Point(40, 416)
        ...
        Me.Label2.Location = New System.Drawing.Point(40, 446)
        ...
        'txtUserName
        '
        Me.txtUserName.Location = New System.Drawing.Point(111, 447)
        ...
        Me.Label3.Location = New System.Drawing.Point(40, 476)
        ...
        'txtPassword
        '
        Me.txtPassword.Location = New System.Drawing.Point(111, 477)
        ...
        Me.cmdAdd.Location = New System.Drawing.Point(410, 418)
        ...
        Me.cmdEdit.Location = New System.Drawing.Point(488, 418)
        ...
        Me.cmdCancel.Location = New System.Drawing.Point(488, 418)
        ...
        Me.cmdDelete.Location = New System.Drawing.Point(566, 418)
        ...
        Me.cmdSave.Location = New System.Drawing.Point(566, 418)
        ...
        Me.cmdExit.Location = New System.Drawing.Point(644, 418)
        ...
        'txtRole
        '
        Me.txtRole.Location = New System.Drawing.Point(111, 507)
        ...
        Me.Label4.Location = New System.Drawing.Point(40, 506)
        ...
        Me.ClientSize = New System.Drawing.Size(1332, 546)
...
#End Region
    ...
    Private Sub Sub_Insert()
        Try
            ...
            Password.Value = BusinessObject.Encr(Trim(txtPassword.Text))
            Params(2) = Password
            ...
            '    MsgBox(ex.Message)
            'End Try
            LogHelper.InsertLog("UserTabCT_Insert.Success")
        Catch ex As Exception
            MsgBox(ex.Message)
            LogHelper.InsertLog("UserTabCT_Insert.Error: " & ex.Message)
        End Try
    ...
    Private Sub Sub_Update()
        Try
            ...
            LogHelper.InsertLog("UserTabCT_Update.Success")
        Catch ex As Exception
            MsgBox(ex.Message)
            LogHelper.InsertLog("UserTabCT_Update.Error: " & ex.Message)
        End Try
    End Sub
    ...
    Private Sub Sub_Show()
        Try
            ...
            LogHelper.InsertLog("UserTabCT_Show.Success")
        Catch ex As Exception
            MsgBox(ex.Message)
            LogHelper.InsertLog("UserTabCT_Show.Error: " & ex.Message)
        End Try
    End Sub
    ...
    Private Sub Sub_Delete()
        Try
            ...
            LogHelper.InsertLog("UserTabCT_Delete")
        Catch ex As Exception
            MsgBox(ex.Message)
            LogHelper.InsertLog("UserTabCT_Delete.Error: " & ex.Message)
        End Try
    End Sub
    ...
    Private Sub DataGrid1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrid1.Click, DataGrid1.CurrentCellChanged
        ...
        With DataGrid1
            ...
            txtPassword.Text = xDec.Decr(Trim(.Item(.CurrentCell.RowNumber, 3).ToString))
    ...
    Private Sub Label3_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Label3.DoubleClick
        If Trim(gRole) = "Admin" And EditMode = True Then
            If cPwd = False Then
                txtPassword.PasswordChar = Nothing
                'txtPassword.Text = Trim(txtPassword.Text)
                cPwd = True
            ElseIf cPwd = True Then
