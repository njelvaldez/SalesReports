...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.DataGridTableStyle1.MappingName = "ProductLinesCT_Show"
        ...
        Me.Name = "ProductLinesCT"
        Me.Text = "Product Lines"
...
#End Region
    ...
    Private Sub Sub_Insert()
        Try
            ...
            BusinessObject.Sub_Insert(ServerPath2, "ProductLinesCT_Insert", CommandType.StoredProcedure, Params)

            LogHelper.InsertLog("ProductLinesCT_Insert.Success")
        Catch ex As Exception
            MsgBox(ex.Message)
            LogHelper.InsertLog("ProductLinesCT_Insert.Error: " & ex.Message)
        End Try
    ...
    Private Sub Sub_Update()
        Try
            ...
            BusinessObject.Sub_Update(ServerPath2, "ProductLinesCT_Update", CommandType.StoredProcedure, Params)

            LogHelper.InsertLog("ProductLinesCT_Update.Success")
        Catch ex As Exception
            MsgBox(ex.Message)
            LogHelper.InsertLog("ProductLinesCT_Update.Error: " & ex.Message)
        End Try

    End Sub
    Private Sub Sub_Show()
        Try
            If RemoteDataSet2.ProductLinesCT_Show.Count > 0 Then RemoteDataSet2.ProductLinesCT_Show.Clear()
            Dim BusinessObject As New BusinessLayer.clsFileMaintenance
            BusinessObject.Sub_Show(ServerPath2, "ProductLinesCT_Show", CommandType.StoredProcedure, RemoteDataSet2, "ProductLinesCT_Show")
            DataGrid1.DataSource = RemoteDataSet2.ProductLinesCT_Show

            LogHelper.InsertLog("ProductLinesCT_Show.Success")
        Catch ex As Exception
            MsgBox(ex.Message)
            LogHelper.InsertLog("ProductLinesCT_Show.Error: " & ex.Message)
        End Try
    ...
    Private Sub Sub_Select(ByVal dbParams() As String, ByVal UpdateMode As String)
        ...
        Select Case UpdateMode
            Case "Insert"
                Dim BusinessObject As New BusinessLayer.clsFileMaintenance
                myRowid = CInt(BusinessObject.Sub_ReturnIntegerResult(ServerPath2, "ProductLinesCT_GetInsertedRowid", CommandType.StoredProcedure))
            Case "Update"
                myRowid = CInt(dbParams(0))
        End Select
        For i = 0 To (RemoteDataSet2.ProductLinesCT_Show.Rows.Count - 1)
            With DataGrid1
    ...
    Private Sub Sub_Delete()
        Try
            ...
            BusinessObject.Sub_Delete(ServerPath2, "ProductLinesCT_Delete", CommandType.StoredProcedure, Params)

            LogHelper.InsertLog("ProductLinesCT_Delete.Success")
        Catch ex As Exception
            MsgBox(ex.Message)
            LogHelper.InsertLog("ProductLinesCT_Delete.Error: " & ex.Message)
        End Try

    End Sub
    Private Sub ProductLinesCT_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        modControlBehavior.EnableControls(Me, False)
    End Sub
