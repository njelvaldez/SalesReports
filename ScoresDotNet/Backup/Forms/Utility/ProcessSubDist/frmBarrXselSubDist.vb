...
Public Class frmBarrXselSubDist
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If row > -1 Then
            ...
            myLoadedForm.ItemCode = dgvSales.Rows(row).Cells(13).Value.ToString
            myLoadedForm.ItemName = dgvSales.Rows(row).Cells(14).Value.ToString
            'Set DataMap Search column
            myLoadedForm.gbCustomer.Text = "BARRXSEL CUSTOMER"
            myLoadedForm.gbItem.Text = "BARRXSEL ITEM"
            myLoadedForm.txtUnit.Text = dgvSales.Rows(row).Cells(15).Value.ToString
            myLoadedForm.txtUnitPrice.Text = dgvSales.Rows(row).Cells(20).Value.ToString
