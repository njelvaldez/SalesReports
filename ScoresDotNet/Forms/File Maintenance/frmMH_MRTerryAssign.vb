...
Public Class MHMedRepTerAssign
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.DataGridTableStyle1.MappingName = "MH_MRterri_Show"
        '
        'principalmr
        '
        ...
        Me.DGridTabStyl.MappingName = "MH_MRterriT_Show"
        '
        'dgTerritoryCode
        '
        ...
        Me.DGTabStyle2.MappingName = "MH_MRterriP_Show"
        '
        'dgPrinCode
        '
        ...
        'cboMedRep
        '
        Me.cboMedRep.Location = New System.Drawing.Point(439, 639)
        ...
        Me.btnPMR.Location = New System.Drawing.Point(7, 480)
        Me.btnPMR.Name = "btnPMR"
        Me.btnPMR.Size = New System.Drawing.Size(61, 20)
        ...
        Me.Name = "MHMedRepTerAssign"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = " My Health Specialist Territory Assignment"
...
#End Region
    ...
    Private Sub Sub_Insert()
        ...
        Try
            BusinessObject.Sub_Insert(ServerPath2, "MH_MRterri_Insert", CommandType.StoredProcedure, Params)
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
    End Sub
    ...
    Private Sub Sub_Update()
        ...
        Try
            BusinessObject.Sub_Update(ServerPath2, "MH_MRterri_Update", CommandType.StoredProcedure, Params)
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
    End Sub
    ...
    Private Sub Sub_Show()
        If RemoteDataSet2.MH_MRterri_Show.Count > 0 Then RemoteDataSet2.MH_MRterri_Show.Clear()
        ...
        If LoadSw = False Then
            ...
            LoadSw = True
        End If
        GrdCount = RemoteDataSet2.MH_MRterriT_Show.Count
        ...
        Params(0) = WerClause
        Try
            BusinessObject.Sub_Show(ServerPath2, "MH_MRterri_Show", CommandType.StoredProcedure, RemoteDataSet2, "MH_MRterri_Show", Params)
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try

        DataGrid1.DataSource = RemoteDataSet2.MH_MRterri_Show
        'SqlValue.DataSource = Nothing : SqlValue.DisplayMember = "" : SqlValue.ResetText()
        'SqlValue2.DataSource = Nothing : SqlValue2.DisplayMember = "" : SqlValue2.ResetText()
    End Sub

    Private Sub Load_PrincipalLst()
        If RemoteDataSet2.MH_MRterriP_Show.Count > 0 Then RemoteDataSet2.MH_MRterriP_Show.Clear()
        Dim BusinessObject As New BusinessLayer.clsFileMaintenance
        BusinessObject.Sub_Show(ServerPath2, "MH_MRterriP_Show", CommandType.StoredProcedure, RemoteDataSet2, "MH_MRterriP_Show")
        DataGrid2.DataSource = RemoteDataSet2.MH_MRterriP_Show
    End Sub

    Private Sub Load_Territory()
        If RemoteDataSet2.MH_MRterriT_Show.Count > 0 Then RemoteDataSet2.MH_MRterriT_Show.Clear()
        Dim BusinessObject As New BusinessLayer.clsFileMaintenance
        BusinessObject.Sub_Show(ServerPath2, "MH_MRterriT_Show", CommandType.StoredProcedure, RemoteDataSet2, "MH_MRterriT_Show")
        DataGrid3.DataSource = RemoteDataSet2.MH_MRterriT_Show
    End Sub
    ...
    Private Sub Sub_Select(ByVal dbParams() As String, ByVal UpdateMode As String)
        ...
        Select Case UpdateMode
            Case "Insert"
                Dim BusinessObject As New BusinessLayer.clsFileMaintenance
                myRowid = CInt(BusinessObject.Sub_ReturnIntegerResult(ServerPath2, "MH_MRterri_GetInsertedRowid", CommandType.StoredProcedure))
            Case "Update"
                myRowid = CInt(dbParams(0))
        End Select
        For i = 0 To (RemoteDataSet2.MH_MRterri_Show.Rows.Count - 1)
            With DataGrid1
    ...
    Private Sub Sub_Delete()
        ...
        Params(0) = Rowid
        Try
            BusinessObject.Sub_Delete(ServerPath2, "MH_MRterri_Delete", CommandType.StoredProcedure, Params)
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
    End Sub
