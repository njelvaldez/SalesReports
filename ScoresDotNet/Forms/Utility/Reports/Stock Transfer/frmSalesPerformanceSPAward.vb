...
Public Class frmSalesPerformanceSPAward
    ...
    Private Sub SetPath()
        ...
        txtOutput.Text = salesinvupdpath + "Sales Performance Specialist " + currentdate + ".xls"
    End Sub
    ...
    Private Sub ShowInvoice(generateonly As Boolean)
        Try
            ...
            BusinessObject.Sub_Show(ServerPath2, "Util_SalesPerformanceSPAward", CommandType.StoredProcedure, RemoteDataSet, "IntegratedSales", Params)
    ...
    Private Sub GenerateSales(ByVal strFileName As String)
        ...
        Try
            ...
            xl.Quit()
            xl = Nothing
            MessageBox.Show("Sales Performance Specialist Award Report generation is complete!")
        Catch ex As Exception
            MessageBox.Show(ex.Message, "frmSalesPerformanceSPAward.GenerateSalesTrend module")
        Finally
        End Try
    End Sub
