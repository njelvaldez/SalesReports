...
Public Class frmSalesPerformanceSPTM
    ...
    Private Sub SetPath()
        ...
        txtTemplate.Text = salesinvupdpath + "Sales Performance Source.xlsx"
        txtOutput.Text = salesinvupdpath + "Sales Performance Source " + currentdate + ".xlsx"
    End Sub
    ...
    Private Sub ShowInvoice(generateonly As Boolean)
        Try
            ...
            'Display SP
            BusinessObject.Sub_Show(ServerPath2, "Util_SalesPerformanceSPSelect", CommandType.StoredProcedure, RemoteDataSet, "IntegratedSales", Params0)
            ...
            BusinessObject.Sub_Show(ServerPath2, "Util_SalesPerformanceTMSelect", CommandType.StoredProcedure, RemoteDataSet2, "IntegratedSales", Paramstm)
            ...
            LogHelper.InsertLog("frmSalesPerformanceSPTM.ShowInvoice.Success")
        Catch ex As Exception
            MsgBox(ex.Message)
            LogHelper.InsertLog("frmSalesPerformanceSPTM.ShowInvoice.Error: " & ex.Message)
        End Try
    End Sub
    ...
    Private Sub GenerateSalesPerformance(ByVal strFileName As String)
        ...
        Try
            ...
            For Each dr As DataRow In dtsp.Rows
                ...
                'commissiondate, 
                strArrsp(rownumbersp, 6) = dr("commissiondate").ToString
                'VacantSP, 
            ...
            For Each dr As DataRow In dttm.Rows
                ...
                'commissiondate, 
                strArrtm(rownumbertm, 6) = dr("commissiondate").ToString
                'VacantTM, 
            ...
            xl.Quit()
            xl = Nothing
            MessageBox.Show("Sales Performance Specialists/TM Report generation is complete!")
        Catch ex As Exception
            MessageBox.Show(ex.Message, "frmSalesPerformanceSPTM.GenerateSalesPerformance module")
        Finally
        End Try
    End Sub
