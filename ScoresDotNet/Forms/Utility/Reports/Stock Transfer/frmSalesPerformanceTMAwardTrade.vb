...
Public Class frmSalesPerformanceTMAwardTrade
    ...
    Private Sub SetPath()
        ...
        txtOutput.Text = salesinvupdpath + "Sales Performance Trade Team Manager " + currentdate + ".xls"
    End Sub
    ...
    Private Sub ShowInvoice(generateonly As Boolean)
        Try
            ...
            BusinessObject.Sub_Show(ServerPath2, "Util_SalesPerformanceTMAwardTrade", CommandType.StoredProcedure, RemoteDataSet, "IntegratedSales", Params)
            ...
            LogHelper.InsertLog("frmSalesPerformanceTMAwardTrade.ShowInvoice.Success")
        Catch ex As Exception
            MsgBox(ex.Message)
            LogHelper.InsertLog("frmSalesPerformanceTMAwardTrade.ShowInvoice.Error: " & ex.Message)
        End Try
    End Sub
    ...
    Private Sub GenerateSales(ByVal strFileName As String)
        ...
        Catch ex As Exception
            MessageBox.Show(ex.Message, "frmSalesPerformanceTMAwardTrade.GenerateSalesTrend module")
        Finally
        End Try
    End Sub
