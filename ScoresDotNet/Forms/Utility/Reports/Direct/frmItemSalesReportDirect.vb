...
Public Class frmItemSalesReportDirect
    ...
    Private Sub SetPath()
        ...
        txtOutput.Text = salesinvupdpath + "Item Sales Report Direct " + currentdate + ".xlsx"
    End Sub
    Private Sub btnCancel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCancel.Click
        Me.Close()
    End Sub

    Private Sub frmItemSalesReportDirect_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub ShowInvoice(generateonly As Boolean)
        Try
            ...
            BusinessObject.Sub_Show(ServerPath2, "Util_ItemSalesDirect_Select", CommandType.StoredProcedure, RemoteDataSet, "IntegratedSales", Params)
            ...
            LogHelper.InsertLog("frmItemSalesReportDirect.ShowInvoice.Success")
        Catch ex As Exception
            MsgBox(ex.Message)
            LogHelper.InsertLog("frmItemSalesReportDirect.ShowInvoice.Error: " & ex.Message)
        End Try
    End Sub
    ...
    Private Sub GenerateSalesTrend(ByVal strFileName As String)
        ...
        Try
            ...
            Next
            range.Value2 = strArr
            ws.Range("A2").Value = "Item Sales Report - Direct"
            ...
            xl.Quit()
            xl = Nothing
            MessageBox.Show("Item Sales Direct Report generation is complete!")
        Catch ex As Exception
            MessageBox.Show(ex.Message, "frmItemSalesReportDirect.GenerateSalesTrend module")
        Finally
        End Try
    End Sub
