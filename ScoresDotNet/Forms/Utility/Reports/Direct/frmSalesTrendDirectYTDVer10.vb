...
Public Class frmSalesTrendDirectYTDVer10
    ...
    Private Sub SetPath()
        ...
        txtTemplate.Text = salesinvupdpath + "Sales Trend Direct YTD Ver 10.xlsx"
        txtOutput.Text = salesinvupdpath + "Sales Trend Direct YTD Ver 10 " + currentdate + ".xlsx"
    End Sub
    Private Sub btnCancel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCancel.Click
        Me.Close()
    End Sub

    Private Sub frmSalesTrendYTDVer10_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub ShowInvoiceMDI(generateonly As Boolean)
        Try
            If RemoteDataSet.Tables("IntegratedSales").Rows.Count > 0 Then RemoteDataSet.Tables("IntegratedSales").Clear()
            Dim BusinessObject As New BusinessLayer.clsFileMaintenance
            Dim salesfrom As DateTime
            ...
            If Not generateonly Then
                BusinessObject.Sub_Update(ServerPath2, "Util_SalesTrend_Directver10ProcessMDI", CommandType.StoredProcedure, Params)
            End If
    ...
    Private Sub GenerateSales(ByVal strFileName As String)
        ...
        Try
            ...
            xl.Quit()
            xl = Nothing
            MessageBox.Show("Sales Trend Direct YTD Ver 10 Report generation is complete!")
        Catch ex As Exception
            MessageBox.Show(ex.Message, "frmSalesTrendDirectYTDver10.GenerateSalesTrend module")
        Finally
        End Try
    End Sub
    ...
    Private Sub btnProcGenMDI_Click(sender As Object, e As EventArgs) Handles btnProcGenMDI.Click
        Dim salesinvupdfile As String = txtTemplate.Text.ToString
        'SetDate()
        Me.Cursor = Cursors.WaitCursor
        ShowInvoice(False)
    ...
    Private Sub btnGenMDIOnly_Click(sender As Object, e As EventArgs) Handles btnGenMDIOnly.Click
        Dim salesinvupdfile As String = txtTemplate.Text.ToString
        'SetDate()
        Me.Cursor = Cursors.WaitCursor
        ShowInvoice(True)
