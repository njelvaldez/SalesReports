...
Public Class frmSalesTrendDirectMAT
    ...
    Private Sub SetPath()
        ...
        txtTemplate.Text = salesinvupdpath + "Sales Trend Direct MAT.xlsx"
        txtOutput.Text = salesinvupdpath + "Sales Trend Direct MAT " + currentdate + ".xlsx"
    End Sub
    Private Sub btnCancel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCancel.Click
        Me.Close()
    End Sub

    Private Sub frmSalesTrendDirectMAT_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub ShowInvoice(generateonly As Boolean)
        Try
            ...
            If Not generateonly Then
                BusinessObject.Sub_Update(ServerPath2, "Util_SalesTrend_DirectProcess", CommandType.StoredProcedure, Params)
            End If
            ...
            BusinessObject.Sub_Show(ServerPath2, "Util_SalesTrend_DirectSelect", CommandType.StoredProcedure, RemoteDataSet, "IntegratedSales", Params0)
        ...
        Catch ex As Exception
            MsgBox(ex.Message)
            LogHelper.InsertLog("frmSalesPerformanceSPAward.ShowInvoice.Error: " & ex.Message)
        End Try
    End Sub
    ...
    Private Sub GenerateSales(ByVal strFileName As String)
        ...
        Try
            ...
            For Each dr As DataRow In dt.Rows
                ...
                'CMONTH, 
                strArr(rownumber, 14) = dr("CMONTH").ToString
                'TYQTY, 
            ...
            xl.Quit()
            xl = Nothing
            MessageBox.Show("Sales Trend Direct MAT Report generation is complete!")
        Catch ex As Exception
            MessageBox.Show(ex.Message, "frmSalesTrendDirectMAT.GenerateSalesTrend module")
        Finally
        End Try
    End Sub
