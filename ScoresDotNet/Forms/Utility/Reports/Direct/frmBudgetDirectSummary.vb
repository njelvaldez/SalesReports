...
Public Class frmBudgetDirectSummary
    ...
    Private Sub SetPath()
        ...
        txtTemplate.Text = salesinvupdpath + "Budget Report Direct Summary Template.xlsx"
        txtOutput.Text = salesinvupdpath + "Budget Report Direct Summary " + currentdate + ".xlsx"
    End Sub
    Private Sub btnCancel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCancel.Click
        Me.Close()
    End Sub

    Private Sub frmBudgetDirectSummary_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub ShowInvoice(generateonly As Boolean)
        Try
            ...
            BusinessObject.Sub_Show(ServerPath2, "Util_Budget_DirectSummary", CommandType.StoredProcedure, RemoteDataSet, "IntegratedSales", Params)
            ...
            LogHelper.InsertLog("frmBudgetDirectSummary.ShowInvoice.Success")
        Catch ex As Exception
            MsgBox(ex.Message)
            LogHelper.InsertLog("frmBudgetDirectSummary.ShowInvoice.Error: " & ex.Message)
        End Try
    End Sub
    Private Sub GenerateSales(ByVal strFileName As String)
        ...
        Try
            ...
            range = wssalestrend.Range("A2", "B" + reccount.ToString().Trim)
            'bud.distributorcode,dst.name,bud.startdate,sum(amount)[amount]
            Dim strArr(reccount, 2) As Object
            For Each dr As DataRow In dt.Rows
                strArr(rownumber, 0) = dr("startdate").ToString
                strArr(rownumber, 1) = dr("amount").ToString
            ...
            'Refresh PivotTable3
            ws.PivotTables("PivotTable1").SourceData = "Source!R1C1:R" + (rownumber + 1).ToString.Trim + "C2"
            ...
            xl.Quit()
            xl = Nothing
            MessageBox.Show("Budget Direct Summary Report is generated successfully!")
        Catch ex As Exception
            MessageBox.Show(ex.Message, "frmBudgetDirectSummary.GenerateSalesTrend module")
        Finally
        End Try
    End Sub
