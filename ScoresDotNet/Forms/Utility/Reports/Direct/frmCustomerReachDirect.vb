...
Public Class frmCustomerReachDirect
    ...
    Private Sub SetPath()
        ...
        txtTemplate.Text = salesinvupdpath + "Customer Reach Analysis Direct.xlsx"
        txtOutput.Text = salesinvupdpath + "Customer Reach Analysis Direct " + currentdate + ".xlsx"
    End Sub
    Private Sub btnCancel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCancel.Click
        Me.Close()
    End Sub

    Private Sub frmCustomerReachDirect_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub ShowInvoice(generateonly As Boolean)
        Try
            ...
            If Not generateonly Then
                BusinessObject.Sub_Update(ServerPath2, "Util_CustomerReachDirect_Process", CommandType.StoredProcedure, Params)
            End If
            ...
            BusinessObject.Sub_Show(ServerPath2, "Util_CustomerReachDirect_Select", CommandType.StoredProcedure, RemoteDataSet, "IntegratedSales", Params0)
            ...
            LogHelper.InsertLog("frmCustomerReachDirect.ShowInvoice.Success")
        Catch ex As Exception
            MsgBox(ex.Message)
            LogHelper.InsertLog("frmCustomerReachDirect.ShowInvoice.Error: " & ex.Message)
        End Try
    End Sub
    ...
    Private Sub GenerateSales(ByVal strFileName As String)
        ...
        Try
            ...
            range = wssalestrend.Range("A2", "O" + reccount.ToString().Trim)

            Dim strArr(reccount, 15) As Object
            For Each dr As DataRow In dt.Rows
                ...
                'PRODUCTLINE, 
                strArr(rownumber, 3) = dr("PRODUCTLINE").ToString
                'DISTRIBUTOR, 
                ...
                'CUSTOMERNAME, 
                strArr(rownumber, 7) = dr("CUSTOMERNAME").ToString
                'REGION, 
                strArr(rownumber, 8) = dr("REGION").ToString
                'GEOREGION, 
                ...
                'yearname, 
                strArr(rownumber, 14) = dr("yearname").ToString
            ...
            'ws.PivotTables("PivotTable1").SourceData = "Source!R1C1:R" + (rownumber + 1).ToString.Trim + "C15"
            ...
            xl.Quit()
            xl = Nothing
            MessageBox.Show("Customer Reach Analysis Direct Report generation is complete!")
        Catch ex As Exception
            MessageBox.Show(ex.Message, "frmCustomerReachDirect.GenerateSalesTrend module")
        Finally
        End Try
    End Sub
