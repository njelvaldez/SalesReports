...
Public Class frmSalesPerformanceDirect
    ...
    Private Sub SetPath()
        ...
        txtTemplate.Text = salesinvupdpath + "Sales Performance Direct YTD.xlsx"
        txtOutput.Text = salesinvupdpath + "Sales Performance Direct YTD " + currentdate + ".xlsx"
    End Sub
    Private Sub btnCancel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCancel.Click
        Me.Close()
    End Sub

    Private Sub frmSalesPerformanceDirect_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
