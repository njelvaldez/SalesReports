...
Public Class frmBudgetDirectReport
    ...
    Private Sub SetPath()
        ...
        txtTemplate.Text = salesinvupdpath + "Budget Report Direct Template.xlsx"
        txtOutput.Text = salesinvupdpath + "Budget Report Direct " + currentdate + ".xlsx"
    End Sub
    Private Sub btnCancel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCancel.Click
        Me.Close()
    End Sub

    Private Sub frmBudgetDirectReport_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub ShowInvoice(generateonly As Boolean)
        Try
            ...
            BusinessObject.Sub_Show(ServerPath2, "Util_Budget_DirectYTD", CommandType.StoredProcedure, RemoteDataSet, "IntegratedSales", Params)
            ...
            LogHelper.InsertLog("frmBudgetDirectReport.ShowInvoice.Success")
        Catch ex As Exception
            MsgBox(ex.Message)
            LogHelper.InsertLog("frmBudgetDirectReport.ShowInvoice.Error: " & ex.Message)
        End Try
    End Sub
    Private Sub GenerateSales(ByVal strFileName As String)
        ...
        Try
            ...
            Dim strArr(reccount, 4) As Object
            For Each dr As DataRow In dt.Rows
                strArr(rownumber, 0) = dr("distributorcode").ToString
                strArr(rownumber, 1) = dr("name").ToString
                strArr(rownumber, 2) = dr("startdate").ToString
            ...
            'Refresh PivotTable3
            ws.PivotTables("PivotTable1").SourceData = "Source!R1C1:R" + (rownumber + 1).ToString.Trim + "C4"
            ...
            xl.Quit()
            xl = Nothing
            MessageBox.Show("Budget Direct Report is generated successfully!")
        Catch ex As Exception
            MessageBox.Show(ex.Message, "frmBudgetDirectReport.GenerateSalesTrend module")
        Finally
        End Try
    End Sub
