...
Public Class frmTransferToTSSP
    ...
    Private Sub UpdateIntegratedSales()
        ...
        Try
            ...
            For Each dr As DataRow In dt.Rows
                ...
                BusinessObject.Sub_Update(ServerPath2, "Util_IntegratedSales_TransferSalesToTSSP", CommandType.StoredProcedure, Params)
            Next
            MsgBox("Transfer of sales to TS SP is complete!")
        Catch ex As Exception
