...
Public Class frmTransferSPBudget
    ...
    Private Sub frmTransferSPBudget_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub LoadSpecialistBudget()
        Try
            Dim BusinessObject As New BusinessLayer.clsFileMaintenance
            ...
            If txtFromMrName.Text <> "" And txtfromdate.Text <> "" And IsDate(txtfromdate.Text) Then
                ...
                BusinessObject.Sub_Show(ServerPath2, "MedrepCT_Budget", CommandType.StoredProcedure, RemoteDataSet, "Area", Params)
            End If
