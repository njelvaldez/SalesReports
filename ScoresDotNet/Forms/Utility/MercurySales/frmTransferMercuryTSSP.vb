...
Public Class frmTransferMercuryTSSP
    ...
    Private Sub frmTransferMercuryTSSP_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub LoadSpecialistMercury()
        Try
            ...
            If txtFromMrName.Text <> "" And txtfromdate.Text <> "" And IsDate(txtfromdate.Text) Then
                ...
                BusinessObject.Sub_Show(ServerPath2, "MedrepCT_MercuryTSSP", CommandType.StoredProcedure, RemoteDataSet, "Area", Params)
            End If
