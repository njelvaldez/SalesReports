...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.ReportViewer.CachedPageNumberPerDoc = 10
        Me.ReportViewer.Location = New System.Drawing.Point(8, 8)
        Me.ReportViewer.Name = "ReportViewer"
        Me.ReportViewer.SelectionFormula = ""
        Me.ReportViewer.Size = New System.Drawing.Size(1010, 729)
    ...
    Private Sub frmReportViewer_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            Select Case Report
                ...
                Case "SM Manager Incentive Computation"
                    ...
                    With myCommand
                        ...
                        .CommandText = "Report_SMMgrIncentiveComputation"
                    ...
                    myDataAdapter.Fill(myDataset, "SMIncAttach")

                    Dim myReport As New Report_SMManagerIncentiveComputation
                    myReport.SetDataSource(myDataset.Tables("SMIncAttach"))
                    ReportViewer.ReportSource = myReport
                    '2. SM Manager Sales Performance
                Case "SM Manager Sales Performance"
                    Dim myDialogBox As New frmDialogBox
                    Dim myConnection As New SqlConnection
                    With myConnection
                        .ConnectionString = ServerPath2
                    ...
                    With myCommand
                        .Connection = myConnection
                        .CommandText = "Report_SMManagerSalesPerformance"
                        .CommandType = CommandType.StoredProcedure
                        .Parameters.Add("@CommissionDate", SqlDbType.DateTime, 10).Value = CommissionDate
                    End With
                    ...
                    Dim myReport As New Report_SMMgrSalesPerfomance
                    myReport.SetDataSource(myDataset.Tables("SMIncAttach"))
                    ReportViewer.ReportSource = myReport
                    '3.SM Manager ASP Computation
                Case "SM Manager ASP Computation"
                    Dim myDialogBox As New frmDialogBox
                    Dim myConnection As New SqlConnection
                    With myConnection
                        .ConnectionString = ServerPath2
                    ...
                    With myCommand
                        .Connection = myConnection
                        .CommandText = "Report_SMManagerASPComputation"
                        .CommandType = CommandType.StoredProcedure
                        .Parameters.Add("@CommissionDate", SqlDbType.DateTime, 10).Value = CommissionDate
                    End With
                    ...
                    Dim myReport As New Report_SMManagerASPComputation
                    myReport.SetDataSource(myDataset.Tables("SMIncAttach"))
                    ReportViewer.ReportSource = myReport

                    '4. TM Hitting Target
                Case "TM Hitting Target"
                    Dim myDialogBox As New frmDialogBox
                    Dim myConnection As New SqlConnection
                    With myConnection
                        .ConnectionString = ServerPath2
                    ...
                    With myCommand
                        .Connection = myConnection
                        .CommandText = "Report_TMHittingTarget"
                        .CommandType = CommandType.StoredProcedure
                        .Parameters.Add("@CommissionDate", SqlDbType.DateTime, 10).Value = CommissionDate
                    End With
                    ...
                    myDataAdapter.SelectCommand = myCommand
                    Dim myDataset As New dsMdiSalesPerMedrep
                    myDataAdapter.Fill(myDataset, "TMHittingTarget")

                    Dim myReport As New Report_TMHittingTarget
                    myReport.SetDataSource(myDataset.Tables("TMHittingTarget"))
                    ReportViewer.ReportSource = myReport
                    '5.SM Manager Incentive Computation Summary
                Case "SM Manager Incentive Computation Summary"
                    Dim myDialogBox As New frmDialogBox
                    Dim myConnection As New SqlConnection
                    With myConnection
                        .ConnectionString = ServerPath2
                    ...
                    With myCommand
                        .Connection = myConnection
                        .CommandText = "Report_SMMgrIncentiveComputationSummary"
                        .CommandType = CommandType.StoredProcedure
                        .Parameters.Add("@CommissionDate", SqlDbType.DateTime, 10).Value = CommissionDate
                    End With
                    ...
                    Dim myReport As New Report_SMMgrIncentiveCompSummary
                    myReport.SetDataSource(myDataset.Tables("SMIncAttach"))
                    ReportViewer.ReportSource = myReport
                ...
                Case "Commission Report Attachment 2015"
                    Dim myDialogBox As New frmDialogBox
                    Dim myConnection As New SqlConnection
                    With myConnection
                        .ConnectionString = ServerPath2
                    ...
                    With myCommand
                        .Connection = myConnection
                        .CommandText = "Report_CommissionAttachment2015"
                        .CommandType = CommandType.StoredProcedure
                        .Parameters.Add("@CommissionDate", SqlDbType.DateTime, 10).Value = CommissionDate
                    End With
                    Dim myDataAdapter As New SqlDataAdapter
                    ...
                    Dim myReport As New Report_CommissionAttachment2015
                    myReport.SetDataSource(myDataset.Tables("REPORT_CommissionAttachment"))
                    ReportViewer.ReportSource = myReport
                ...
                Case "Medrep Commission with Recovery2014"
                    ...
                    End Try '02272013<<]
                    'Added by ARValdez
                Case "Medrep Commission with Recovery2015"
                    Try
                        If Not CommissionDate = Nothing Then
                            Dim myCommand As New SqlCommand
                            With myCommand
                            ...
                            With myCommand
                                .Connection = DataMaintenance.objConnection(ServerPath2)
                                .CommandText = "SegmentRule_MedrepCommission_Details2015"
                                .CommandType = CommandType.StoredProcedure
                                .Parameters.Add(myParameter)
                            End With
                            myDataAdapter.SelectCommand = myCommand
                            myDataAdapter.Fill(myDataset, "MedrepCommission_Details2009")
                            Dim myReport As New Report_MedrepCommissionWithRecovery2015
                            myReport.SetDataSource(myDataset)
                            ReportViewer.ReportSource = myReport
                        Else
                            Return '**return nothing
                ...
                Case "Medrep Commission with RecoveryCombi2015"
                    Try
                        If Not CommissionDate = Nothing Then
                            Dim myCommand As New SqlCommand
                            With myCommand
                                .Connection = DataMaintenance.objConnection(ServerPath2)
                                .CommandText = "ComIncRecoverCombi_Select"
                                .CommandType = CommandType.StoredProcedure
                            End With
                            Dim myDataAdapter As New SqlDataAdapter
                            myDataAdapter.SelectCommand = myCommand
                            'removed by arv 7/24/2015 Dim myDataset As New ComincRecover2009
                            Dim myDataset As New DataSet
                            myDataset.Tables.Add("ComIncRecover")
                            myDataset.Tables.Add("MedrepCommission_Details2009")
                            myDataAdapter.Fill(myDataset, "ComIncRecover")
                            Dim myParameter As New SqlParameter
                            With myParameter
                                .ParameterName = "@CommissionDate"
                            ...
                            With myCommand
                                .Connection = DataMaintenance.objConnection(ServerPath2)
                                .CommandText = "SegmentRule_MedrepCommission_DetailsCombi2015"
                                .CommandType = CommandType.StoredProcedure
                                .Parameters.Add(myParameter)
                            End With
                            myDataAdapter.SelectCommand = myCommand
                            myDataAdapter.Fill(myDataset, "MedrepCommission_Details2009")
                            Dim myReport As New Report_MedrepCommissionWithRecovery2015Combi3
                            myReport.SetDatabaseLogon("sa", "jynxz")
                            myReport.SetDataSource(myDataset)
                            ReportViewer.ReportSource = myReport
                        Else
                            Return '**return nothing
                ...
                Case "DSM Commission with Recovery2015"
                    Try
                        If Not CommissionDate = Nothing Then
                            Dim myCommand As New SqlCommand
                            With myCommand
                            ...
                            Dim myReport As New Report_DSMCommissionWithRecovery2015
                            myReport.SetDataSource(myDataset)
                            ReportViewer.ReportSource = myReport
                ...
                Case "Segment-Supervisor-Specialist"
                    Me.Cursor = Cursors.WaitCursor
                    Dim _sCommissionDate As String = CommissionDate
                    ...
                    Try
                        If Not _sCommissionDate = Nothing Then
                            ...
                            With myCommand
                                .Connection = myConnection
                                .CommandText = "Util_AreaPMR_Report"
                                .CommandType = CommandType.StoredProcedure
                                .Parameters.Add("@CommissionDate", SqlDbType.DateTime, 10).Value = _sCommissionDate
                            End With
                            ...
                            Dim myReport As New crpSupervisorSpecialist
                            myReport.SetDataSource(myDataset.Tables("REPORT_CommissionAttachment"))
                            ReportViewer.ReportSource = myReport
                        Else
                            Me.Cursor = Cursors.Default
