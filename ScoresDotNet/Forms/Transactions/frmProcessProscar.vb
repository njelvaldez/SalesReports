...
Public Class frmProcessProscarData
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmProcessProscarData))
        ...
        Me.Name = "frmProcessProscarData"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Process Proscar Data"
...
#End Region
    ...
    Private Function UpdateFromFileField() As Boolean
        ...
        If CommissionDate > "" Then
            ...
            UpdateString = "Delete from ProscarData where FromFile=" & "'" & strFromFile & "'"
            DataMaintenance.ExecuteCommand(ServerPath2, UpdateString, CommandType.Text)

            'Upload Parameters
            UpdateString = "FixProscarRawData"
        ...
        If chkProcess.CheckState = CheckState.Checked Then
            'Upload Parameters
            UpdateString = "ProcessData_MSD_Direct"     '"ProcessData_ProscarData"
            DataMaintenance.myParamArray(0, 0) = "@FileName"
            DataMaintenance.myParamArray(0, 1) = SqlDbType.VarChar
    ...
    Private Sub GetNewCustomers(ByVal ResultType As String)
        Select Case ResultType
            Case "Count"
                UpdateString = "Select count(FromFile) from ProscarData where " & _
            ...
            Case "Rows"
                    ...
                    "Address1,Address2 from ProscarData where CustCode not in" & _
    ...
    Private Sub GetNewItems(ByVal ResultType As String)
        Select Case ResultType
            ...
            Case "Rows"
                ...
                "listprice [UnitPrice] from ProscarData where itemno not in" & _
    ...
    Private Sub GetPesoAmounts(ByVal AmountType As String)
        Select Case AmountType
            Case "Input"
                UpdateString = "Select sum(ValAmt) from ProscarData where " & _
                               "FromFile = " & " '" & strFromFile & "'"
    ...
    Private Sub Insert_ExcelFile(ByVal ParamArray SubData() As String)
        ...
        cm.CommandText = "Insert_ProscarData"
        ...
        Dim qtyorder As New SqlParameter("@QtyOrder", SqlDbType.Int, 4)
        qtyorder.Direction = ParameterDirection.Input
        cm.Parameters.Add(qtyorder)

        Dim qtyfree As New SqlParameter("@QtyFree", SqlDbType.Int, 4)
    ...
    Private Sub frmProcessProscarData_MouseMove(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles MyBase.MouseMove
