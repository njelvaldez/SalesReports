...
Public Class SupMr
    ...
    Friend WithEvents dg_DivCode As System.Windows.Forms.DataGridTextBoxColumn
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(SupMr))
        ...
        Me.dg_DivCode = New System.Windows.Forms.DataGridTextBoxColumn()
        ...
        Me.DataGridTableStyle2.GridColumnStyles.AddRange(New System.Windows.Forms.DataGridColumnStyle() {Me.dg_SupCode, Me.dg_DSM, Me.dg_StartDate, Me.dg_EndDate, Me.dg_Rowno, Me.dg_TeamDivision, Me.dg_Division, Me.dg_Create, Me.dg_Update, Me.dg_LastUsr, Me.dg_DivCode})
        ...
        'txtFilter
        '
        Me.txtFilter.Location = New System.Drawing.Point(1224, 104)
        Me.txtFilter.Name = "txtFilter"
        Me.txtFilter.Size = New System.Drawing.Size(95, 20)
        Me.txtFilter.TabIndex = 71
        '
        'btnFilter
        '
        Me.btnFilter.BackgroundImage = Global.ScoresDotNet.My.Resources.Resources.filter
        ...
        Me.btnFilter.Location = New System.Drawing.Point(1224, 130)
        Me.btnFilter.Name = "btnFilter"
        Me.btnFilter.Size = New System.Drawing.Size(95, 24)
        Me.btnFilter.TabIndex = 72
        Me.btnFilter.Text = "Filter"
        '
        'dg_DivCode
        '
        Me.dg_DivCode.Format = ""
        Me.dg_DivCode.FormatInfo = Nothing
        Me.dg_DivCode.HeaderText = "DivCode"
        Me.dg_DivCode.MappingName = "divcode"
        Me.dg_DivCode.Width = 75
        '
        'SupMr
        '
...
#End Region
    ...
    Private Sub PMR_Show()
        Try
            ...
            Dim MrName As New SqlParameter("@MrName", SqlDbType.VarChar, 50) : MrName.Direction = ParameterDirection.Input : MrName.Value = txtFilter.Text.ToString.Trim : Params(0) = MrName

            If String.IsNullOrEmpty(txtFilter.Text.ToString) Then
                BusinessObject.Sub_Show(ServerPath2, "MedRepCT_Show", CommandType.StoredProcedure, _
                                   RemoteDataSet, "MedRepCT_Show")
            Else
                BusinessObject.Sub_Show(ServerPath2, "MedRepCT_ShowFilter", CommandType.StoredProcedure, _
                   RemoteDataSet, "MedRepCT_Show", Params)
            End If
    ...
    Private Sub btnDSM_Edit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) _
        ...
        With DataGrid1
            ...
            Fld21 = Trim(.Item(.CurrentCell.RowNumber, 10).ToString)
        End With
        DSM_EditMode = True
        cancelProcess = False
        popupFrm.ShowDialog(Me)
