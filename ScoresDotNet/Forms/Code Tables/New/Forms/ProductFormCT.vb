...
Public Class ProductFormCT
    Inherits System.Windows.Forms.Form
    Private RemoteDataSet As New DataSet
    Friend WithEvents btnSearch As System.Windows.Forms.Button
    Friend WithEvents txtSearch As System.Windows.Forms.TextBox 'Removed by Angelo 12062013 CodeTablesDS
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents txtProductForm As System.Windows.Forms.TextBox
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(ProductFormCT))
        ...
        Me.txtProductForm = New System.Windows.Forms.TextBox()
        ...
        Me.DataGridTextBoxColumn3.HeaderText = "Product Form"
        Me.DataGridTextBoxColumn3.MappingName = "ProductForm"
        ...
        Me.GroupBox1.Text = "Product Form List"
        '
        'GroupBox2
        '
        Me.GroupBox2.Controls.Add(Me.txtProductForm)
        ...
        Me.GroupBox2.Text = "Product Form Detail"
        '
        'txtProductForm
        '
        Me.txtProductForm.Location = New System.Drawing.Point(120, 68)
        Me.txtProductForm.Name = "txtProductForm"
        Me.txtProductForm.Size = New System.Drawing.Size(256, 20)
        Me.txtProductForm.TabIndex = 49
        Me.txtProductForm.Tag = "Input"
        '
        'txtRowid
        '
        ...
        Me.cmdEdit.Location = New System.Drawing.Point(1056, 576)
        ...
        'cmdCancel
        '
        Me.cmdCancel.Location = New System.Drawing.Point(1056, 576)
        ...
        Me.cmdDelete.Location = New System.Drawing.Point(1144, 576)
        ...
        Me.cmdSave.Location = New System.Drawing.Point(1144, 576)
        ...
        Me.cmdAdd.Location = New System.Drawing.Point(968, 576)
        ...
        'cmdExit
        '
        Me.cmdExit.Location = New System.Drawing.Point(1232, 576)
        ...
        Me.btnSearch.Location = New System.Drawing.Point(298, 574)
        ...
        'txtSearch
        '
        Me.txtSearch.Location = New System.Drawing.Point(8, 582)
        ...
        Me.Name = "ProductFormCT"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Product Form Maintenance"
...
#End Region
    ...
    Private Sub cmdEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdEdit.Click
        If txtDimCode.Text = "" And txtProductForm.Text = "" Then
    ...
    Private Sub Sub_Insert()
        Try
            ...
            Dim TypeDesc As New SqlParameter("@ProductForm", SqlDbType.VarChar, 50) : TypeDesc.Direction = ParameterDirection.Input : TypeDesc.Value = txtProductForm.Text : Params(1) = TypeDesc
            ...
            BusinessObject.Sub_Insert(ServerPath2, "ProductFormCT_Insert", CommandType.StoredProcedure, Params)

            LogHelper.InsertLog("ProductFormCT_Insert")
        Catch ex As Exception
            MsgBox(ex.Message)
            LogHelper.InsertLog("ProductFormCT_Insert.Error: " & ex.Message)
        End Try
    ...
    Private Sub Sub_Update()
        Try
            ...
            BusinessObject.Sub_Update(ServerPath2, "ProductFormCT_Update", CommandType.StoredProcedure, Params)

            LogHelper.InsertLog("ProductFormCT_Update.Success")
        Catch ex As Exception
            MsgBox(ex.Message)
            LogHelper.InsertLog("ProductFormCT_Update.Error: " & ex.Message)
        End Try
    ...
    Private Sub Sub_Show()
        Try
            ...
            If Trim(txtSearch.Text = "") Then
                BusinessObject.Sub_Show(ServerPath2, "ProductFormCT_Show", CommandType.StoredProcedure, RemoteDataSet, "ProductFormCT_Show")
            Else
                Dim Params(0) As SqlParameter
                Dim productform As New SqlParameter("@productform ", SqlDbType.VarChar, 50)
                productform.Direction = ParameterDirection.Input
                productform.Value = txtSearch.Text.ToString.Trim
                Params(0) = productform
                BusinessObject.Sub_Show(ServerPath2, "ProductFormCT_Show_Search", CommandType.StoredProcedure, RemoteDataSet, "ProductFormCT_Show", Params)
            End If
    ...
    Private Sub Sub_Select(ByVal dbParams() As String, ByVal UpdateMode As String)
        ...
        Select Case UpdateMode
            Case "Insert"
                Dim BusinessObject As New BusinessLayer.clsFileMaintenance
                myRowid = CInt(BusinessObject.Sub_ReturnIntegerResult(ServerPath2, "ProductFormCT_GetInsertedRowid", CommandType.StoredProcedure))
            Case "Update"
    ...
    Private Sub DataGrid1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrid1.Click, DataGrid1.CurrentCellChanged
        With DataGrid1
            ...
            txtProductForm.Text = CStr(.Item(.CurrentCell.RowNumber, 2))
