...
Public Class frm4thKeyProducts
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.DataGrid1.Size = New System.Drawing.Size(552, 293)
        ...
        Me.DataGridTableStyle1.GridColumnStyles.AddRange(New System.Windows.Forms.DataGridColumnStyle() {Me.DataGridTextBoxColumn1, Me.DataGridTextBoxColumn2, Me.DataGridTextBoxColumn3, Me.DataGridTextBoxColumn9, Me.DataGridTextBoxColumn4, Me.DataGridTextBoxColumn5, Me.DataGridTextBoxColumn6, Me.DataGridTextBoxColumn7, Me.DataGridTextBoxColumn8, Me.DataGridTextBoxColumn10})
        Me.DataGridTableStyle1.HeaderForeColor = System.Drawing.SystemColors.ControlText
        Me.DataGridTableStyle1.MappingName = "KeyProducts4th_Show"
        '
        ...
        Me.DataGridTextBoxColumn9.MappingName = "PushProductsDesc"
        ...
        Me.Label1.Location = New System.Drawing.Point(5, 309)
        ...
        Me.ComboBox1.Location = New System.Drawing.Point(92, 307)
        ...
        Me.Label2.Location = New System.Drawing.Point(5, 333)
        ...
        Me.ComboBox2.Location = New System.Drawing.Point(92, 331)
        ...
        Me.DateTimePicker1.Location = New System.Drawing.Point(356, 307)
        ...
        Me.DateTimePicker2.Location = New System.Drawing.Point(356, 331)
        ...
        Me.Label3.Location = New System.Drawing.Point(300, 309)
        ...
        Me.Label4.Location = New System.Drawing.Point(300, 333)
        ...
        Me.Label5.Location = New System.Drawing.Point(5, 361)
        ...
        'txtIncentiveRate
        '
        Me.txtIncentiveRate.Location = New System.Drawing.Point(90, 358)
        Me.txtIncentiveRate.Name = "txtIncentiveRate"
        Me.txtIncentiveRate.Size = New System.Drawing.Size(192, 20)
        Me.txtIncentiveRate.TabIndex = 51
        '
        'DataGridTextBoxColumn10
        '
        Me.DataGridTextBoxColumn10.Format = ""
        Me.DataGridTextBoxColumn10.FormatInfo = Nothing
        Me.DataGridTextBoxColumn10.HeaderText = "Incentive Rate"
        Me.DataGridTextBoxColumn10.MappingName = "Incentiverate"
        ...
        Me.Name = "frm4thKeyProducts"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.Manual
        Me.Text = "4th Key Products"
...
#End Region
    ...
    Private Sub SaveChanges()
        Select Case EditMode
            Case True
                ...
                If DataMaintenance.ExecuteCommand(ServerPath2, "KeyProducts4th_Update", CommandType.StoredProcedure, 8) Then
                    MessageBox.Show("Row Changes in 4th Key Products  saved")
                End If
            Case False
                DataMaintenance.myParamArray(0, 0) = "@Line"
                DataMaintenance.myParamArray(0, 1) = SqlDbType.VarChar
                ...
                If DataMaintenance.ExecuteCommand(ServerPath2, "KeyProducts4th_Insert", CommandType.StoredProcedure, 8) Then
                    MessageBox.Show("New 4th Key Products Row saved")
                End If
        End Select
    ...
    Private Sub Sub_Select(ByVal dbParams() As String, ByVal UpdMode As String)
        ...
        Select Case UpdMode
            Case "Insert"
                ...
                myRowid = CInt(BusinessObject.Sub_ReturnIntegerResult(ServerPath2, "KeyProducts4th_GetInsertedRowid", CommandType.StoredProcedure))
            Case "Update"
                myRowid = CInt(dbParams(0))
        End Select
        For i = 0 To (RemoteDataSet2.KeyProducts4th_Show.Rows.Count - 1)
            With DataGrid1
    ...
    Private Sub Load_DataGrid()
        If RemoteDataSet2.KeyProducts4th_Show.Count > 0 Then RemoteDataSet2.KeyProducts4th_Show.Clear()
        Dim BusinessObject As New BusinessLayer.clsFileMaintenance
        BusinessObject.Sub_Show(ServerPath2, "KeyProducts4th_Show", CommandType.StoredProcedure, RemoteDataSet2, "KeyProducts4th_Show")
        DataGrid1.DataSource = RemoteDataSet2.KeyProducts4th_Show
    End Sub
    ...
    Private Sub DataGrid1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrid1.Click
        ...
        txtLastUser.Text = Trim(DataGrid1.Item(DataGrid1.CurrentCell.RowNumber, 8).ToString)
        txtIncentiveRate.Text = Trim(DataGrid1.Item(DataGrid1.CurrentCell.RowNumber, 9).ToString)
    End Sub
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        If MessageBox.Show("Delete this product line?", "Product Lines", MessageBoxButtons.YesNo) = DialogResult.Yes Then
            ...
            If DataMaintenance.ExecuteCommand(ServerPath2, "KeyProducts4th_Delete", CommandType.StoredProcedure, 1) = True Then
                MessageBox.Show("4th Key Products row deleted!")
