...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents cboPMo As System.Windows.Forms.TextBox
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.cboPMo = New System.Windows.Forms.TextBox
        ...
        'cboPM
        '
        Me.cboPM.Location = New System.Drawing.Point(79, 70)
        Me.cboPM.MaxLength = 53
        Me.cboPM.Name = "cboPM"
        Me.cboPM.Size = New System.Drawing.Size(286, 21)
        Me.cboPM.TabIndex = 2
        Me.cboPM.Tag = "Input"
        '
        'cboPMo
        '
        Me.cboPMo.Enabled = False
        Me.cboPMo.Location = New System.Drawing.Point(241, 15)
        Me.cboPMo.Name = "cboPMo"
        Me.cboPMo.Size = New System.Drawing.Size(42, 20)
        Me.cboPMo.TabIndex = 174
        Me.cboPMo.Text = "TextBox2"
        Me.cboPMo.Visible = False
        '
        'vStart_DateO
        '
        Me.vStart_DateO.Enabled = False
        Me.vStart_DateO.Location = New System.Drawing.Point(200, 15)
        ...
        Me.Text = "Item's Product Manager History"
...
#End Region
    ...
    Private Sub Ipm_Entry_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Itm_EditMode = False Then
            ...
            vStart_Date.Select()
        Else
            cboPM.Text = Filds(4).ToString
        End If
    End Sub

    Private Sub Load_PM()
        Dim BusinessObject As New BusinessLayer.clsFileMaintenance
        BusinessObject.Sub_Show(ServerPath2, "PM_Combo", CommandType.StoredProcedure, RemoteDataSet, "PM_Combo")
        cboPM.DataSource = RemoteDataSet.PM_Combo
        cboPM.DisplayMember = "PM"
    End Sub
    ...
    Private Sub Sub_Insert()
        ...
        PMCode.Value = GetCode(cboPM.Text)
        Params(3) = PMCode
        ...
        Try
            BusinessObject.Sub_Insert(ServerPath2, "ItemPM_ins", CommandType.StoredProcedure, Params)
    ...
    Private Sub Sub_Update()
        ...
        Dim PMCode2 As New SqlParameter("@PMCodeO", SqlDbType.VarChar, 3)
        PMCode2.Direction = ParameterDirection.Input
        PMCode2.Value = GetCode(cboPMo.Text)
        Params(7) = PMCode2

        Try
            BusinessObject.Sub_Insert(ServerPath2, "ItemPM_upd", CommandType.StoredProcedure, Params)
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
    End Sub
    ...
    Private Sub EditLoadedFilds()
        ...
        cboPM.Text = Filds(2).ToString
        vStart_Date.Text = Filds(3).ToString
        vEnd_Date.Text() = Filds(4).ToString
        vUpdateDate.Text = Filds(5).ToString
    End Sub

    Private Sub cboPM_KeyUp(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cboPM.KeyUp
        If e.KeyData.ToString = System.Windows.Forms.Keys.Up.ToString _
           Or e.KeyData.ToString = System.Windows.Forms.Keys.Left.ToString Then 'if key pressed is the up arrow it will select the next selection before the selction
            cboPM.SelectedItem = cboPM.SelectedIndex - 1
        ...
        ElseIf DKcodes(e.KeyData) = True Then    'checking if the key pressed is alphanumeric (to disallow typing the entry)
            cboPM.Text = ""     'if alphanumeric then the value of the field will be erased
        End If
    ...
    Private Sub cboPM_Validating(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles cboPM.Validating
        If Trim(cboPM.Text) = "" Then    'tests if entry is blank
