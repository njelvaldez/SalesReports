...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.DataGridTextBoxColumn7.HeaderText = "Specialist"
...
#End Region
    ...
    Private Sub Sub_Insert()
        Try
            ...
            LogHelper.InsertLog("QpiTerritoryBudgetCT_Insert.Success")
        Catch ex As Exception
            MsgBox(ex.Message)
            LogHelper.InsertLog("QpiTerritoryBudgetCT_Insert.Error: " & ex.Message)
        End Try
    ...
    Private Sub Sub_Update()
        Try
            ...
            LogHelper.InsertLog("QpiTerritoryBudgetCT_Update.Success")
        Catch ex As Exception
            MsgBox(ex.Message)
            LogHelper.InsertLog("QpiTerritoryBudgetCT_Update.Error: " & ex.Message)
        End Try
    End Sub
    Private Sub Sub_Show()
        Try
            ...
            LogHelper.InsertLog("QpiTerritoryBudgetCT_Show.Success")
        Catch ex As Exception
            MsgBox(ex.Message)
            LogHelper.InsertLog("QpiTerritoryBudgetCT_Show.Error: " & ex.Message)
        End Try
    ...
    Private Sub Sub_Delete()
        Try
            ...
            LogHelper.InsertLog("QpiTerritoryBudgetCT_Delete.Success")
        Catch ex As Exception
            MsgBox(ex.Message)
            LogHelper.InsertLog("QpiTerritoryBudgetCT_Delete.Error: " & ex.Message)
        End Try
    End Sub
