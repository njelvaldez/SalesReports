...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(TerritoryCT))
        ...
        'txtSearch
        '
        Me.txtSearch.Location = New System.Drawing.Point(16, 312)
        ...
        Me.btnSearch.Location = New System.Drawing.Point(256, 301)
        Me.btnSearch.Name = "btnSearch"
        Me.btnSearch.Size = New System.Drawing.Size(74, 36)
    ...
    Private Sub Sub_Show()
        Try
            ...
            Else
                ...
                Dim territory As New SqlParameter("@territory", SqlDbType.VarChar, 50)
                territory.Direction = ParameterDirection.Input
                territory.Value = txtSearch.Text.ToString.Trim
                Params(0) = territory
                BusinessObject.Sub_Show(ServerPath2, "TerritoryCT_Show_Search", CommandType.StoredProcedure, RemoteDataSet2, "TerritoryCT_Show", Params)
            End If
