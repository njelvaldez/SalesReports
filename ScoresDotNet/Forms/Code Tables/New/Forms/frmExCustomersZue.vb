...
Public Class frmExCustomersZue
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmExCustomersZue))
        ...
        Me.DataGridTableStyle1.MappingName = "ExcludeCustomerZue_Show"
        ...
        Me.Name = "frmExCustomersZue"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.Manual
        Me.Text = "Excluded Customers - Zuelig"
...
#End Region
    ...
    Private Sub Sub_Insert()
        ...
        Params(8) = LastUser
        Try
            BusinessObject.Sub_Insert(ServerPath2, "ExcludeCustomerZue_Insert", CommandType.StoredProcedure, Params)
    ...
    Private Sub Sub_Update()
        ...
        Params(8) = LastUser
        Try
            BusinessObject.Sub_Insert(ServerPath2, "ExcludeCustomerZue_Update", CommandType.StoredProcedure, Params)
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
    End Sub
    ...
    Private Sub Sub_Show()
        If RemoteDataSet2.ExcludeCustomerZue_Show.Count > 0 Then RemoteDataSet2.ExcludeCustomerZue_Show.Clear()
        Dim BusinessObject As New BusinessLayer.clsFileMaintenance
        BusinessObject.Sub_Show(ServerPath2, "ExcludeCustomerZue_Show", CommandType.StoredProcedure, RemoteDataSet2, "ExcludeCustomerZue_Show")
        DataGrid1.DataSource = RemoteDataSet2.ExcludeCustomerZue_Show
    End Sub
    ...
    Private Sub Sub_Select(ByVal dbParams() As String, ByVal UpdateMode As String)
        ...
        Select Case UpdateMode
            Case "Insert"
                Dim BusinessObject As New BusinessLayer.clsFileMaintenance
                myRowid = CInt(BusinessObject.Sub_ReturnIntegerResult(ServerPath2, "ExcludeCustomerZue_GetInsertedRowid", CommandType.StoredProcedure))
            Case "Update"
                myRowid = CInt(dbParams(0))
        End Select
        For i = 0 To (RemoteDataSet2.ExcludeCustomerZue_Show.Rows.Count - 1)
            With DataGrid1
    ...
    Private Sub Sub_Delete()
        ...
        Params(0) = Rowid
        Try
            BusinessObject.Sub_Delete(ServerPath2, "ExcludeCustomerZue_Delete", CommandType.StoredProcedure, Params)
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
    End Sub
