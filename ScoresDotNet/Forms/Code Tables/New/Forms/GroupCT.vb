...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(GroupCT))
        ...
        'txtDescription
        '
        Me.txtDescription.Location = New System.Drawing.Point(120, 424)
        ...
        Me.DataGrid1.Size = New System.Drawing.Size(1312, 384)
        ...
        Me.DataGridTableStyle1.MappingName = "GroupCT_Show"
        ...
        Me.DataGridTextBoxColumn2.MappingName = "Code"
        ...
        Me.ClientSize = New System.Drawing.Size(1326, 556)
...
#End Region
    ...
    Private Sub Sub_Insert()
        Try
            ...
            Dim TypeCode As New SqlParameter("@Code", SqlDbType.VarChar, 25) : TypeCode.Direction = ParameterDirection.Input : TypeCode.Value = txtCode.Text : Params(0) = TypeCode
            Dim TypeDesc As New SqlParameter("@Group", SqlDbType.VarChar, 50) : TypeDesc.Direction = ParameterDirection.Input : TypeDesc.Value = txtDescription.Text : Params(1) = TypeDesc
            ...
            BusinessObject.Sub_Insert(ServerPath2, "GroupCT_Insert", CommandType.StoredProcedure, Params)
            LogHelper.InsertLog("GroupCT_Insert.Success")
        Catch ex As Exception
            MsgBox(ex.Message)
            LogHelper.InsertLog("GroupCT_Insert.Error: " & ex.Message)
        End Try
    End Sub
    Private Sub Sub_Update()
        Try
            ...
            BusinessObject.Sub_Update(ServerPath2, "GroupCT_Update", CommandType.StoredProcedure, Params)
            LogHelper.InsertLog("GroupCT_Update.Success")
        Catch ex As Exception
            MsgBox(ex.Message)
            LogHelper.InsertLog("GroupCT_Update.Error: " & ex.Message)
        End Try
    End Sub
    Private Sub Sub_Show()
        Try
            If RemoteDataSet.GroupCT_Show.Count > 0 Then RemoteDataSet.GroupCT_Show.Clear()
            Dim BusinessObject As New BusinessLayer.clsFileMaintenance
            BusinessObject.Sub_Show(ServerPath2, "GroupCT_Show", CommandType.StoredProcedure, RemoteDataSet, "GroupCT_Show")
            DataGrid1.DataSource = RemoteDataSet.GroupCT_Show
            LogHelper.InsertLog("GroupCT_Show.Success")
        Catch ex As Exception
            MsgBox(ex.Message)
            LogHelper.InsertLog("GroupCT_Show.Error: " & ex.Message)
        End Try
    End Sub
    Private Sub Sub_Select(ByVal dbParams() As String, ByVal UpdateMode As String)
        ...
        Select Case UpdateMode
            Case "Insert"
                Dim BusinessObject As New BusinessLayer.clsFileMaintenance
                myRowid = CInt(BusinessObject.Sub_ReturnIntegerResult(ServerPath2, "GroupCT_GetInsertedRowid", CommandType.StoredProcedure))
            Case "Update"
                myRowid = CInt(dbParams(0))
        End Select
        For i = 0 To (RemoteDataSet.GroupCT_Show.Rows.Count - 1)
            With DataGrid1
    ...
    Private Sub Sub_Delete()
        Try
            ...
            BusinessObject.Sub_Delete(ServerPath2, "GroupCT_Delete", CommandType.StoredProcedure, Params)
            LogHelper.InsertLog("GroupCT_Delete.Success")
        Catch ex As Exception
            MsgBox(ex.Message)
            LogHelper.InsertLog("GroupCT_Delete.Error: " & ex.Message)
        End Try
    End Sub
    Private Sub GroupCT_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        modControlBehavior.EnableControls(Me, False)
    End Sub
