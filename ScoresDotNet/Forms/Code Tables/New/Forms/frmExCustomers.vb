...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmExCustomers))
        ...
        'txtSearch
        '
        Me.txtSearch.Location = New System.Drawing.Point(41, 412)
        ...
        'btnSearch
        '
        Me.btnSearch.Location = New System.Drawing.Point(282, 409)
    ...
    Private Sub Sub_Show()
        Try
            ...
            Else
                ...
                Dim customername As New SqlParameter("@customername", SqlDbType.VarChar, 50)
                customername.Direction = ParameterDirection.Input
                customername.Value = txtSearch.Text.ToString.Trim
                Params(0) = customername
                BusinessObject.Sub_Show(ServerPath2, "ExcludeCustomerListCT_Show_Search", CommandType.StoredProcedure, RemoteDataSet, "ExcludeCustomerListCT_Show", Params)
            End If
