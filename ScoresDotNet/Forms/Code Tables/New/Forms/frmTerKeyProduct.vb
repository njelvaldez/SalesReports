...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Label4.Location = New System.Drawing.Point(292, 382)
        ...
        Me.Label3.Location = New System.Drawing.Point(292, 358)
        ...
        Me.DateTimePicker2.Location = New System.Drawing.Point(356, 380)
        ...
        Me.DateTimePicker1.Location = New System.Drawing.Point(356, 356)
        ...
        Me.ComboBox2.Location = New System.Drawing.Point(92, 380)
        ...
        Me.Label1.Location = New System.Drawing.Point(1, 359)
        ...
        Me.ComboBox1.Location = New System.Drawing.Point(92, 356)
        ...
        Me.DataGrid1.Size = New System.Drawing.Size(552, 345)
        ...
        Me.DataGridTableStyle1.MappingName = "TerKeyProduct_Show"
        '
        ...
        'txtRowid
        '
        Me.txtRowid.Location = New System.Drawing.Point(440, 456)
        Me.txtRowid.Name = "txtRowid"
        Me.txtRowid.Size = New System.Drawing.Size(13, 20)
        Me.txtRowid.TabIndex = 45
        ...
        Me.Label5.Location = New System.Drawing.Point(1, 410)
        ...
        'txtIncentiveRate
        '
        Me.txtIncentiveRate.Location = New System.Drawing.Point(92, 407)
        Me.txtIncentiveRate.Name = "txtIncentiveRate"
        Me.txtIncentiveRate.Size = New System.Drawing.Size(192, 20)
        Me.txtIncentiveRate.TabIndex = 49
        '
        'DataGridTextBoxColumn6
        '
        Me.DataGridTextBoxColumn6.Format = ""
        Me.DataGridTextBoxColumn6.FormatInfo = Nothing
        Me.DataGridTextBoxColumn6.HeaderText = "Incentive Rate"
        Me.DataGridTextBoxColumn6.MappingName = "IncentiveRate"
        ...
        Me.Name = "frmTerKeyProduct"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.Manual
        Me.Text = "Ter Key Product"
...
#End Region
    ...
    Private Sub SaveChanges()
        Select Case EditMode
            Case True
                ...
                DataMaintenance.myParamArray(5, 0) = "@IncentiveRate"
                DataMaintenance.myParamArray(5, 1) = SqlDbType.Money
                DataMaintenance.myParamArray(5, 2) = 10
                DataMaintenance.myParamArray(5, 3) = System.Data.ParameterDirection.Input
                DataMaintenance.myParamArray(5, 4) = "Money"
                DataMaintenance.myParamArray(5, 5) = txtIncentiveRate.Text

                If DataMaintenance.ExecuteCommand(ServerPath2, "TerKeyProduct_Update", CommandType.StoredProcedure, 6) Then
            ...
            Case False
                ...
                DataMaintenance.myParamArray(4, 0) = "@IncentiveRate"
                DataMaintenance.myParamArray(4, 1) = SqlDbType.Money
                DataMaintenance.myParamArray(4, 2) = 10
                DataMaintenance.myParamArray(4, 3) = System.Data.ParameterDirection.Input
                DataMaintenance.myParamArray(4, 4) = "Money"
                DataMaintenance.myParamArray(4, 5) = txtIncentiveRate.Text

                If DataMaintenance.ExecuteCommand(ServerPath2, "TerKeyProduct_Insert", CommandType.StoredProcedure, 5) Then
    ...
    Private Sub Sub_Select(ByVal dbParams() As String, ByVal UpdMode As String)
        ...
        Select Case UpdMode
            Case "Insert"
                ...
                myRowid = CInt(BusinessObject.Sub_ReturnIntegerResult(ServerPath2, "TerKeyProduct_GetInsertedRowid", CommandType.StoredProcedure))
            Case "Update"
                myRowid = CInt(dbParams(0))
        End Select
        For i = 0 To (RemoteDataSet2.TerKeyProduct_Show.Rows.Count - 1)
            With DataGrid1
    ...
    Private Sub Load_DataGrid()
        If RemoteDataSet2.TerKeyProduct_Show.Count > 0 Then RemoteDataSet2.TerKeyProduct_Show.Clear()
        Dim BusinessObject As New BusinessLayer.clsFileMaintenance
        BusinessObject.Sub_Show(ServerPath2, "TerKeyProduct_Show", CommandType.StoredProcedure, RemoteDataSet2, "TerKeyProduct_Show")
        DataGrid1.DataSource = RemoteDataSet2.TerKeyProduct_Show
    End Sub
    Private Sub DataGrid1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrid1.Click
        ...
        txtIncentiveRate.Text = CStr(DataGrid1.Item(DataGrid1.CurrentCell.RowNumber, 5))
    End Sub
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        If MessageBox.Show("Delete this product line?", "Product Lines", MessageBoxButtons.YesNo) = DialogResult.Yes Then
            ...
            If DataMaintenance.ExecuteCommand(ServerPath2, "TerKeyProduct_Delete", CommandType.StoredProcedure, 1) = True Then
