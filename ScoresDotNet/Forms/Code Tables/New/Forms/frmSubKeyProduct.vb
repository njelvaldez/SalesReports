...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Label4.Location = New System.Drawing.Point(292, 385)
        ...
        Me.Label3.Location = New System.Drawing.Point(292, 361)
        ...
        Me.DateTimePicker2.Location = New System.Drawing.Point(356, 383)
        ...
        Me.DateTimePicker1.Location = New System.Drawing.Point(356, 359)
        ...
        Me.Label2.Location = New System.Drawing.Point(1, 385)
        ...
        Me.ComboBox2.Location = New System.Drawing.Point(92, 383)
        ...
        Me.Label1.Location = New System.Drawing.Point(1, 361)
        ...
        Me.ComboBox1.Location = New System.Drawing.Point(92, 359)
        ...
        Me.DataGrid1.Size = New System.Drawing.Size(552, 348)
        ...
        Me.Label5.Location = New System.Drawing.Point(1, 413)
...
#End Region
    ...
    Private Sub SaveChanges()
        Select Case EditMode
            Case True
                ...
                If DataMaintenance.ExecuteCommand(ServerPath2, "SubKeyProduct_Update", CommandType.StoredProcedure, 6) Then
            ...
            Case False
                ...
                If DataMaintenance.ExecuteCommand(ServerPath2, "SubKeyProduct_Insert", CommandType.StoredProcedure, 5) Then
    ...
    Private Sub Sub_Select(ByVal dbParams() As String, ByVal UpdMode As String)
        ...
        Select Case UpdMode
            Case "Insert"
                ...
                myRowid = CInt(BusinessObject.Sub_ReturnIntegerResult(ServerPath2, "SubKeyProductCT_GetInsertedRowid", CommandType.StoredProcedure))
            Case "Update"
                myRowid = CInt(dbParams(0))
        End Select
        For i = 0 To (RemoteDataSet.SubKeyProduct_Show.Rows.Count - 1)
            With DataGrid1
    ...
    Private Sub Load_DataGrid()
        If RemoteDataSet.SubKeyProduct_Show.Count > 0 Then RemoteDataSet.SubKeyProduct_Show.Clear()
        Dim BusinessObject As New BusinessLayer.clsFileMaintenance
