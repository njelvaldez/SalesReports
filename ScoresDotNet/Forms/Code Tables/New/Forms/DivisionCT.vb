...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(DivisionCT))
        ...
        Me.DataGrid1.Size = New System.Drawing.Size(1304, 384)
        ...
        Me.DataGridTextBoxColumn6.HeaderText = "Segment Manager"
        Me.DataGridTextBoxColumn6.MappingName = "Manager"
        Me.DataGridTextBoxColumn6.NullText = ""
        Me.DataGridTextBoxColumn6.Width = 98
        '
        ...
        Me.DataGridTextBoxColumn8.HeaderText = "Segment Status"
        Me.DataGridTextBoxColumn8.MappingName = "Status"
        Me.DataGridTextBoxColumn8.NullText = ""
        Me.DataGridTextBoxColumn8.Width = 88
        '
        ...
        '
        Me.DataGridTextBoxColumn11.Format = CType(configurationAppSettings.GetValue("""MM/dd/yyyy""", GetType(String)), String)
        ...
        'txtRowid
        '
        Me.txtRowid.Location = New System.Drawing.Point(775, 519)
        ...
        'TxtLastUser
        '
        Me.TxtLastUser.Location = New System.Drawing.Point(847, 519)
        ...
        Me.Label9.Size = New System.Drawing.Size(1296, 3)
        ...
        Me.Label12.Location = New System.Drawing.Point(1112, 526)
        ...
        Me.Label11.Location = New System.Drawing.Point(1112, 510)
        ...
        'txtSearch
        '
        Me.txtSearch.Location = New System.Drawing.Point(379, 519)
        ...
        Me.btnSearch.Location = New System.Drawing.Point(638, 510)
        ...
        Me.ClientSize = New System.Drawing.Size(1318, 564)
...
#End Region
    ...
    Private Sub Sub_Insert()
        Try
            ...
            'EndDate.Value = Trim(TxtEndDate.Text)     'tmpED
            If Trim(tmpED) = "" Then
            ...
            LogHelper.InsertLog("DivisionCT_Insert.Success")
        Catch ex As Exception
            MsgBox(ex.Message)
            LogHelper.InsertLog("DivisionCT_Insert.Error: " & ex.Message)
        End Try
    End Sub
    ...
    Private Sub Sub_Update()
        Try
            ...
            LogHelper.InsertLog("DivisionCT_Update.Success")
        Catch ex As Exception
            MsgBox(ex.Message)
            LogHelper.InsertLog("DivisionCT_Update.Error: " & ex.Message)
        End Try
    End Sub
    ...
    Private Sub Sub_Show()
        Try
            ...
            If Trim(txtSearch.Text = "") Then
                BusinessObject.Sub_Show(ServerPath2, "DivisionCT_Show", CommandType.StoredProcedure, _
                                        RemoteDataSet, "DivisionCT_Show")
            Else
                Dim Params(0) As SqlParameter
                Dim divname As New SqlParameter("@divname", SqlDbType.VarChar, 50)
                divname.Direction = ParameterDirection.Input
                divname.Value = txtSearch.Text.ToString.Trim
                Params(0) = divname
                BusinessObject.Sub_Show(ServerPath2, "DivisionCT_Show_Search", CommandType.StoredProcedure, _
                                        RemoteDataSet, "DivisionCT_Show", Params)
            End If
            DataGrid1.DataSource = RemoteDataSet.DivisionCT_Show
            LogHelper.InsertLog("DivisionCT_Show.Success")
        Catch ex As Exception
            LogHelper.InsertLog("DivisionCT_Show.Error: " & ex.Message)
        End Try
    End Sub
    ...
    Private Sub Sub_Delete()
        Try
            ...
            LogHelper.InsertLog("DivisionCT_Delete.Success")
        Catch ex As Exception
            MsgBox(ex.Message)
            LogHelper.InsertLog("DivisionCT_Delete.Error: " & ex.Message)
        End Try
    End Sub
