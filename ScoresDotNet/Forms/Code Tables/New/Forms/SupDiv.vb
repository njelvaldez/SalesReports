...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Label7.Text = "Segment for Team Manager"
...
#End Region
    ...
    Private Sub Sub_Insert()
        Try
            ...
            Dim s As String
            '  v-- removed this because a division can be assigned to multiple supervisors
            ...
            '    RemoteDataSet2.GenericQryProc.Clear()
            'End If
            '  ^-- removed this because a division can be assigned to multiple supervisors
            ...
            LogHelper.InsertLog("SupervisorCT_Div_Insert.Success")
        Catch ex As Exception
            MsgBox(ex.Message)
            LogHelper.InsertLog("SupervisorCT_Div_Insert.Error: " & ex.Message)
        End Try
    ...
    Private Sub Sub_Update()
        Try
            ...
            LogHelper.InsertLog("SupervisorCT_Div_Update.Success")
        Catch ex As Exception
            MsgBox(ex.Message)
            LogHelper.InsertLog("SupervisorCT_Div_Update.Error: " & ex.Message)
        End Try
    End Sub
