...
Public Class Rpt_ActiveMB
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ScoresDotNet.Rpt_ActiveMB.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_ActiveMB
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_ActiveMB = New Rpt_ActiveMB()
        rpt.Site = Me.Site
        Return rpt
    End Function
