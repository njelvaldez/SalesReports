...
#End Region
    ...
    Private Sub Insert_ExcelFile(ByVal ParamArray SubData() As String)
        ...
        Dim qtyorder As New SqlParameter("@QtyOrder", SqlDbType.Int, 4) : qtyorder.Direction = ParameterDirection.Input : cm.Parameters.Add(qtyorder)
        Dim qtyfree As New SqlParameter("@QtyFree", SqlDbType.Int, 4) : qtyfree.Direction = ParameterDirection.Input : cm.Parameters.Add(qtyfree)
        ...
        qtyorder.Value = CInt(SubData(20))
        qtyfree.Value = CInt(SubData(21).ToString)
