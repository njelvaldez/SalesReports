...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.DataGrid3.Size = New System.Drawing.Size(497, 187)
        ...
        'TxtStartDate
        '
        Me.TxtStartDate.Location = New System.Drawing.Point(682, 480)
        ...
        'Label7
        '
        Me.Label7.Location = New System.Drawing.Point(622, 480)
        ...
        'TxtEndDate
        '
        Me.TxtEndDate.Location = New System.Drawing.Point(484, 480)
        ...
        'Label8
        '
        Me.Label8.Location = New System.Drawing.Point(424, 480)
        ...
        Me.DataGrid2.Size = New System.Drawing.Size(304, 187)
        ...
        Me.Label13.Text = "Select a Principal and a Territory before clicking Add. Plus MedRep before clicki" & _
        "ng Edit."
        '
        'cboMedRep
        '
        Me.cboMedRep.Location = New System.Drawing.Point(71, 480)
        ...
        Me.dg4.Location = New System.Drawing.Point(367, 207)
        Me.dg4.Name = "dg4"
        Me.dg4.TabIndex = 73
        ...
        Me.ClientSize = New System.Drawing.Size(818, 595)
        ...
        Me.Text = " MedRep Territory Assignment"
...
#End Region
    ...
    Function tstRecord(ByVal vTer As String) As Boolean
        ...
        z = z & "  and rtrim(territorydr)   = '" & Trim(TxtTerritory.Text) & "' "
        z = z & "  and '" & Trim(TxtStartDate.Text) & "' between start_date and end_date "
        z = z & "  and '" & Trim(TxtEndDate.Text) & "' between start_date and end_date "
        z = z & "  and rtrim(mrcode) = '" & GetCode(cboMedRep.Text) & "' "
    ...
    Private Sub Sub_Show()
        ...
        Dim BusinessObject As New BusinessLayer.clsFileMaintenance
        Dim s As String, terTmp As String
        ...
        z = z & "where rtrim(territorycode) in (" & s & ") "
        ...
        z = z & " and convert(char, territorydr) in (" & xz & ") "
        WerClause.Value = z
        Params(0) = WerClause
        Try
            BusinessObject.Sub_Show(ServerPath2, "MRterri_Show", CommandType.StoredProcedure, RemoteDataSet2, "MRterri_Show", Params)
