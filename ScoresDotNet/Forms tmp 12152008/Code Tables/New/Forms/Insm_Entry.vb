...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents cboNSMo As System.Windows.Forms.TextBox
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.cboNSMo = New System.Windows.Forms.TextBox
        ...
        'cboNSMo
        '
        Me.cboNSMo.Enabled = False
        Me.cboNSMo.Location = New System.Drawing.Point(272, 13)
        Me.cboNSMo.Name = "cboNSMo"
        Me.cboNSMo.Size = New System.Drawing.Size(42, 20)
        Me.cboNSMo.TabIndex = 174
        Me.cboNSMo.Text = ""
        Me.cboNSMo.Visible = False
        '
        'vStart_DateO
        '
        Me.vStart_DateO.Enabled = False
        Me.vStart_DateO.Location = New System.Drawing.Point(215, 15)
        Me.vStart_DateO.Name = "vStart_DateO"
        Me.vStart_DateO.Size = New System.Drawing.Size(39, 20)
        Me.vStart_DateO.TabIndex = 173
        Me.vStart_DateO.Text = ""
        Me.vStart_DateO.Visible = False
        '
        'cboNSM
        '
        Me.cboNSM.Location = New System.Drawing.Point(79, 70)
        Me.cboNSM.MaxLength = 100
        Me.cboNSM.Name = "cboNSM"
        Me.cboNSM.Size = New System.Drawing.Size(286, 21)
        Me.cboNSM.TabIndex = 2
        Me.cboNSM.Tag = "Input"
        '
        'Insm_Entry
        '
        ...
        Me.Text = "Item's Nat'l Sales Mgr History"
...
#End Region
    ...
    Private Sub Insm_Entry_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Sub_Insert()
        ...
        Try
            BusinessObject.Sub_Insert(ServerPath2, "ItemNSM_ins", CommandType.StoredProcedure, Params)
    ...
    Private Sub Sub_Update()
        ...
        Dim NSMCode2 As New SqlParameter("@NSMCodeO", SqlDbType.VarChar, 25)
        NSMCode2.Direction = ParameterDirection.Input
        NSMCode2.Value = GetCode(cboNSMo.Text)
        Params(7) = NSMCode2

        Try
            BusinessObject.Sub_Insert(ServerPath2, "ItemNSM_upd", CommandType.StoredProcedure, Params)
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
    End Sub
    ...
    Private Sub EditLoadedFilds()
        ...
        cboNSM.Text = Filds(2).ToString
        vStart_Date.Text = Filds(3).ToString
        vEnd_Date.Text() = Filds(4).ToString
        vUpdateDate.Text = Filds(5).ToString
    End Sub

    Private Sub cboNSM_KeyUp(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    ...
    Private Sub cboNSM_Validating(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Trim(cboNSM.Text) = "" Then    'tests if entry is blank
