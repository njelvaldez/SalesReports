...
#End Region
    ...
    Private Sub Sub_Show()
        If RemoteDataSet.ProductLinesCT_Show.Count > 0 Then RemoteDataSet.ProductLinesCT_Show.Clear()
        Dim BusinessObject As New BusinessLayer.clsFileMaintenance
        BusinessObject.Sub_Show(ServerPath2, "ProductLinesCT_Show", CommandType.StoredProcedure, RemoteDataSet, "ProductLinesCT_Show")
        DataGrid1.DataSource = RemoteDataSet.ProductLinesCT_Show
    End Sub
    Private Sub Sub_Select(ByVal dbParams() As String, ByVal UpdateMode As String)
        ...
        End Select
        For i = 0 To (RemoteDataSet.ProductLinesCT_Show.Rows.Count - 1)
            With DataGrid1
