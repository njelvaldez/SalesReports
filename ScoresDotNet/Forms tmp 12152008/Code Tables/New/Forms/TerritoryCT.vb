...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'cmdExit
        '
        Me.cmdExit.Location = New System.Drawing.Point(208, 259)
        ...
        'cmdEdit
        '
        Me.cmdEdit.Location = New System.Drawing.Point(80, 259)
        ...
        'cmdCancel
        '
        Me.cmdCancel.Location = New System.Drawing.Point(80, 259)
        ...
        'cmdDelete
        '
        Me.cmdDelete.Location = New System.Drawing.Point(144, 259)
        ...
        'cmdSave
        '
        Me.cmdSave.Location = New System.Drawing.Point(144, 259)
        ...
        Me.txtProvNav.Size = New System.Drawing.Size(184, 20)
        ...
        Me.cboProvince.Size = New System.Drawing.Size(184, 21)
...
#End Region
    ...
    Private Sub Sub_Show()
        If RemoteDataSet.TerritoryCT_Show.Count > 0 Then RemoteDataSet.TerritoryCT_Show.Clear()
        Dim BusinessObject As New BusinessLayer.clsFileMaintenance
        BusinessObject.Sub_Show(ServerPath2, "TerritoryCT_Show", CommandType.StoredProcedure, RemoteDataSet, "TerritoryCT_Show")
        DataGrid1.DataSource = RemoteDataSet.TerritoryCT_Show
    End Sub
    ...
    Private Sub Sub_Select(ByVal dbParams() As String, ByVal UpdateMode As String)
        ...
        End Select
        For i = 0 To (RemoteDataSet.TerritoryCT_Show.Rows.Count - 1)
            With DataGrid1
