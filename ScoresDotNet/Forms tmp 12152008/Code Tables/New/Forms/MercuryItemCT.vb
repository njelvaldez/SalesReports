...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'Label2
        '
        Me.Label2.Location = New System.Drawing.Point(16, 424)
        ...
        'Label4
        '
        Me.Label4.Location = New System.Drawing.Point(16, 472)
        ...
        'txtCode
        '
        Me.txtCode.Location = New System.Drawing.Point(96, 400)
        ...
        Me.lblCreateDate.Location = New System.Drawing.Point(96, 448)
        ...
        Me.lblUpdateDate.Location = New System.Drawing.Point(96, 472)
        ...
        'cboItem
        '
        Me.cboItem.Location = New System.Drawing.Point(96, 424)
...
#End Region
    ...
    Private Sub Sub_Show()
        If RemoteDataSet.MercuryItemCT_Show.Count > 0 Then RemoteDataSet.MercuryItemCT_Show.Clear()
        Dim BusinessObject As New BusinessLayer.clsFileMaintenance
        BusinessObject.Sub_Show(ServerPath2, "MercuryItemCT_Show", CommandType.StoredProcedure, RemoteDataSet, "MercuryItemCT_Show")
        DataGrid1.DataSource = RemoteDataSet.MercuryItemCT_Show
    End Sub
    ...
    Private Sub Sub_Select(ByVal dbParams() As String, ByVal UpdateMode As String)
        ...
        End Select
        For i = 0 To (RemoteDataSet.MercuryItemCT_Show.Rows.Count - 1)
            With DataGrid1
    ...
    Private Sub DataGrid1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrid1.Click, DataGrid1.CurrentCellChanged
        With DataGrid1
            ...
            cboItem.Text = CStr(.Item(.CurrentCell.RowNumber, 2))
