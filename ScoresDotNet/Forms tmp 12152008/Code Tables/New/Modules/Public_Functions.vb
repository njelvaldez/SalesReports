...
Module Public_Functions
    ...
    Function NumKeys(ByVal nk As Object, Optional ByVal Norm_Int As String = "NORM") As Boolean
    ...
    Function KC2int(ByVal ik As Object) As Object
        If ik.ToString = System.Windows.Forms.Keys.D0.ToString Or _
           ...
           ik.ToString = System.Windows.Forms.Keys.Divide.ToString Then
...
DateTrap:
    ...
    Function StrTran$(ByVal arg1 As Object, ByVal arg2 As Object, ByVal arg3 As Object)
        'for converting a specified char or number of chars into another string or char from w/in a specified variable/string
    ...
    Public Function tstExist2(ByVal StrConn As String, _
                            ByVal StordProc As String, _
                            Optional ByVal Params() As SqlParameter = Nothing) As Boolean

        'for testing if a query returns a value or records.
        Dim result As String
        Dim LocalCommand As New SqlCommand
        With LocalCommand
            .Connection = ObjectConnection(StrConn)
            .CommandText = StordProc
