...
Public Class frmQpiTerritory
    Inherits System.Windows.Forms.Form
    Private RemoteDataSet As New dsQpiTerritory
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.DataGridTableStyle1.MappingName = "QpiTerritory_Show"
        ...
        Me.Name = "frmQpiTerritory"
        Me.Text = "QPI Territory"
...
#End Region
    ...
    Private Sub Sub_Insert()
        ...
        Dim Code As New SqlParameter("@Code", SqlDbType.VarChar, 25) : Code.Direction = ParameterDirection.Input : Code.Value = txtCode.Text : Params(0) = Code
        Dim Description As New SqlParameter("@Description", SqlDbType.VarChar, 50) : Description.Direction = ParameterDirection.Input : Description.Value = txtDescription.Text : Params(1) = Description
        ...
        BusinessObject.Sub_Insert(ServerPath2, "QpiTerritory_Insert", CommandType.StoredProcedure, Params)
    End Sub
    Private Sub Sub_Update()
        ...
        BusinessObject.Sub_Update(ServerPath2, "QpiTerritory_Update", CommandType.StoredProcedure, Params)
    End Sub
    Private Sub Sub_Show()
        If RemoteDataSet.QpiTerritory_Show.Count > 0 Then RemoteDataSet.QpiTerritory_Show.Clear()
        Dim BusinessObject As New BusinessLayer.clsFileMaintenance
        BusinessObject.Sub_Show(ServerPath2, "QpiTerritory_Show", CommandType.StoredProcedure, RemoteDataSet, "QpiTerritory_Show")
        DataGrid1.DataSource = RemoteDataSet.QpiTerritory_Show
    End Sub
    Private Sub Sub_Select(ByVal dbParams() As String, ByVal UpdateMode As String)
        ...
        Select Case UpdateMode
            Case "Insert"
                Dim BusinessObject As New BusinessLayer.clsFileMaintenance
                myRowid = CInt(BusinessObject.Sub_ReturnIntegerResult(ServerPath2, "QpiTerritory_GetInsertedRowid", CommandType.StoredProcedure))
            Case "Update"
                myRowid = CInt(dbParams(0))
        End Select
        For i = 0 To (RemoteDataSet.QpiTerritory_Show.Rows.Count - 1)
            With DataGrid1
    ...
    Private Sub Sub_Delete()
        ...
        BusinessObject.Sub_Delete(ServerPath2, "QpiTerritory_Delete", CommandType.StoredProcedure, Params)
    End Sub
    Private Sub frmQpiTerritory_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        modControlBehavior.EnableControls(Me, False)
    End Sub
